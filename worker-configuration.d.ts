/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 39f7ccc4406cbe1cad024afd2bb4c59c)
// Runtime types generated with workerd@1.20260405.1 2026-04-08 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker");
		durableNamespaces: "FamilyBoard";
	}
	interface Env {
		DB: D1Database;
		HOUSEHOLD_NAME: "Maple House";
		FAMILY_BOARD: DurableObjectNamespace<import("./worker").FamilyBoard>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HOUSEHOLD_NAME">> {}
}
