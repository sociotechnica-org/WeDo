  ...
  return (
    <main className="paper-canvas min-h-screen px-4 py-5 sm:px-6 md:px-8 md:py-8 lg:px-10 lg:py-10">
      <div className="mx-auto flex max-w-[76rem] flex-col gap-5">
        <header className="paper-panel rounded-[2.2rem] border border-[rgba(87,72,58,0.08)] px-5 py-5 shadow-[0_18px_36px_rgba(82,65,48,0.06)] md:px-7 lg:px-8">
          <div className="grid gap-5 md:grid-cols-[1fr_auto] md:items-start">
            ...
            <div className="justify-self-start md:justify-self-end">
              ...
              <h2 className="mt-3 text-[2.35rem] leading-none text-[var(--color-ink)]">
                Person management
              </h2>
        ...
        <form
          className="paper-panel rounded-[2.2rem] border border-[rgba(87,72,58,0.08)] px-5 py-6 shadow-[0_18px_36px_rgba(82,65,48,0.06)] md:px-7 md:py-8"
          onSubmit={(event) => {
        ...
        >
          ...
          <ol className="mt-6 space-y-4" data-testid="settings-person-list">
            {draftRows.map((row, index) => {
              ...
              return (
                <li
                  className="rounded-[1.6rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(255,252,247,0.76)] px-4 py-4 shadow-[0_12px_28px_rgba(82,65,48,0.04)]"
                ...
                >
                  <div className="grid gap-4 md:grid-cols-[auto_minmax(0,1fr)_minmax(0,1fr)_auto] md:items-center">
                    <div className="flex items-center gap-2 text-[var(--color-ink-soft)]">
                      ...
                      <div className="flex flex-col gap-2">
                        <button
                          ...
                          className="rounded-[0.9rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(248,242,233,0.86)] px-3 py-2 text-sm text-[var(--color-ink-soft)] disabled:opacity-35"
                    ...
                    <label className="block">
                      ...
                      <input
                        className="mt-2 w-full rounded-[1rem] border border-[rgba(87,72,58,0.12)] bg-[rgba(255,251,246,0.95)] px-3 py-3 text-[1.15rem] text-[var(--color-ink)] shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] outline-none focus:border-[rgba(87,72,58,0.20)]"
                        disabled={isSaving}
                        onChange={(event) => {
                    ...
                    <label className="block">
                      ...
                      <input
                        className="mt-2 w-full rounded-[1rem] border border-[rgba(87,72,58,0.12)] bg-[rgba(255,251,246,0.95)] px-4 py-3 text-[1.02rem] text-[var(--color-ink)] shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] outline-none focus:border-[rgba(87,72,58,0.20)]"
                        disabled={isSaving}
                        onChange={(event) => {
                    ...
                    <div className="flex flex-wrap justify-start gap-2 md:justify-end">
                      {isConfirmingRemoval ? (
                        <>
                          <button
                            className="rounded-[1rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(247,241,233,0.86)] px-4 py-2.5 text-[0.94rem] text-[var(--color-ink-soft)] shadow-[0_10px_22px_rgba(82,65,48,0.04)]"
                            disabled={isSaving}
                            onClick={() => {
                              setConfirmingRemovalId(null);
                            }}
                          ...
                          <button
                            className="rounded-[1rem] border border-[rgba(123,101,82,0.16)] bg-[rgba(246,237,226,0.94)] px-4 py-2.5 text-[0.94rem] text-[var(--color-ink)] shadow-[0_10px_22px_rgba(82,65,48,0.04)]"
                            disabled={isSaving}
                            onClick={() => {
                        ...
                        <button
                          className="rounded-[1rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(248,242,233,0.86)] px-4 py-2.5 text-[0.94rem] text-[var(--color-ink-soft)] shadow-[0_10px_22px_rgba(82,65,48,0.04)] disabled:opacity-35"
          ...
          <section className="mt-8 rounded-[1.8rem] border border-dashed border-[rgba(87,72,58,0.12)] bg-[rgba(250,246,240,0.68)] px-4 py-5 md:px-5">
            <p className="scribe-label text-[0.68rem] uppercase tracking-[0.32em] text-[var(--color-ink-soft)]">
              Add a Person
            </p>
            <div className="mt-4 grid gap-4 md:grid-cols-[10rem_minmax(0,1fr)_auto] md:items-end">
              ...
              <button
                className="rounded-[1.2rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(255,252,247,0.92)] px-5 py-3 text-[0.96rem] text-[var(--color-ink)] shadow-[0_10px_22px_rgba(82,65,48,0.05)] disabled:opacity-60"
                disabled={isSaving}
          ...
          <div className="mt-8 flex flex-wrap justify-end gap-3">
            <Link
              className="rounded-[1.2rem] border border-[rgba(87,72,58,0.08)] bg-[rgba(247,241,233,0.86)] px-5 py-3 text-[0.96rem] text-[var(--color-ink-soft)] shadow-[0_10px_22px_rgba(82,65,48,0.04)]"
              to={dashboardHref}
            >
              Cancel
            </Link>
            <button
              className="rounded-[1.2rem] border border-[rgba(87,72,58,0.10)] bg-[rgba(255,252,247,0.92)] px-5 py-3 text-[0.96rem] text-[var(--color-ink)] shadow-[0_10px_22px_rgba(82,65,48,0.05)] disabled:cursor-not-allowed disabled:opacity-60"
              disabled={isSaving}
              type="submit"
            >
